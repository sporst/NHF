...
public class PlaTranslator
{
	public static List<ReilInstruction> translate(final StandardEnvironment environment, final Instruction instruction)
	{
		...
		instructions.addAll(StackTranslator.incrementStackPointer(baseOffset, environment));
		instructions.add(ReilHelpers.createLdm(baseOffset + instructions.size(), OperandSize.BYTE, "SP", OperandSize.BYTE, "A"));
